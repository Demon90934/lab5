""" Функции - это удобный способ разделить ваш код на полезные блоки,
сделать его более читабельным и помочь в его повторном использовании.
...
def fun():
    print("Чтобы дойти до цели, надо прежде всего идти")
    print(" " * 10 + "О. Бальзак")
...
for k in range (1, 4): # Основная программа
    mess()
# -----------------------------------------------------------------------------------------#
...
def fib(n):
    ...
    while a < n:
        result.append(a)
        tmp_var = b
        b = b + a # обновите значение переменной b, поместив в нее сумму значений
